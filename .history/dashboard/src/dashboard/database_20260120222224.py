...
def get_trade_summary(days: int = 30, session_type: Optional[str] = None) -> dict:
...
def get_daily_performance(days: int = 90, session_type: Optional[str] = None) -> pd.DataFrame:
