...
class BacktestConfig:
    ...
    position_size_level1: float = 0.5
    position_size_level2: float = 0.3
    position_size_level3: float = 0.2
    
    # Trailing stop parameter (NEW)
    trailing_stop_pct: float = 0.0  # 0 = disabled, 0.02 = 2% trailing stop
