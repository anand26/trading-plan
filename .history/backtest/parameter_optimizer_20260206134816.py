...
class ParameterOptimizer:
    ...
    def load_combinations_from_csv(
        ...
        - zscore_lookback, entry_zscore, exit_zscore, stop_zscore
        - position_size, stop_loss_pct
        - trend_filter_enabled, sma_fast_period, sma_slow_period
        - daily_loss_limit_pct, max_drawdown_pct, drawdown_position_scale
        - enable_vol_scaling, vol_scale_high_thresh, vol_scale_med_thresh
        - warmup_days
        ...
        for idx, row in df.iterrows():
            ...
            # Strategy parameters (v4.0 Pairs Ratio Strategy)
            param_columns = [
                # Algorithm selection
                'algorithm_name',
                
                # Z-score parameters (Pairs Strategy)
                'zscore_lookback',
                ...
                # Volatility scaling
                'enable_vol_scaling',
                'vol_scale_high_thresh', 'vol_scale_med_thresh',
                'vol_scale_high_factor', 'vol_scale_med_factor',
    ...
    def _get_parameter_defaults(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # Position sizing
            'position_size': 0.57,      # 57% of portfolio (optimized)
