...
class ParameterOptimizer:
    ...
    def _get_parameter_defaults(self) -> Dict[str, Any]:
        """Get default parameter values for v2.1 Hybrid Strategy (Mean-Reversion + Volume)."""
        return {
            # ==========================================
            # HYBRID v2.1 PARAMETERS (PRIMARY)
            # Mean-Reversion Core + Volume Confirmation + Wider Stops
            # ==========================================
            
            # RSI Mean-Reversion (PRIMARY)
            'rsi_period': 14,
            'rsi_oversold': 28.0,  # Best from v1.7
            'rsi_overbought': 72.0,
            ...
            # Risk management - WIDER STOPS
            'stop_loss_pct': 0.025,  # 2.5% (wider than v1.x 2%)
