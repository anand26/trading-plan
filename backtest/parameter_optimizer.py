...
class ParameterOptimizer:
    ...
    def _get_parameter_defaults(self) -> Dict[str, Any]:
        """Get default parameter values for v3.0 Pairs Ratio Strategy."""
        return {
            # ==========================================
            # PAIRS RATIO v3.0 PARAMETERS (PRIMARY)
            # ==========================================
            'algorithm_name': 'TQQQSQQQPairsAlgorithm',
            
            # Z-score parameters
            'zscore_lookback': 50,      # 50 bars = ~4 hours of 5-min data
            'entry_zscore': 1.5,        # Enter when |Z| > 1.5
            'exit_zscore': 0.3,         # Exit when |Z| < 0.3
