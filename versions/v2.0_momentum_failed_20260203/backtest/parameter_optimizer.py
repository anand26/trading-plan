...
class ParameterOptimizer:
    ...
    def load_combinations_from_csv(
        ...
        for idx, row in df.iterrows():
            ...
            # Strategy parameters (v2.0 Momentum + legacy for compatibility)
            param_columns = [
                # Momentum v2.0 parameters
                'breakout_bars',
                'rsi_period', 'rsi_momentum_min', 'rsi_momentum_max',
                ...
                'ema_fast_period', 'ema_slow_period',
                'bb_period', 'bb_std_dev',
                # Legacy v1.x parameters (for backward compatibility)
